...
if __name__ == "__main__":
    ...
    # sim_data_vector = get_data_from_sim_run_listload_all_simulation_runs("data/todo/default_name/output")
    # model = RLController(12, 64, 8)
    ...
    # # train_from_model(optimizer, model, num_points=10_000, num_epochs=1000, batch_size=64)
